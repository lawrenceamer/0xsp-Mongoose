...
`Agent` has been coded as ELF with `Lazarus Free Pascal` will be released with ( 32 , 64 bit) , <b>the source code of it still not released , but will be in upcoming releasing </b>.
